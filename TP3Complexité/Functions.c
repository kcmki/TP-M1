...
/*                 if(T->tours[last][T->indice[last]] % 2 == T->tours[temp1][T->indice[temp1]] % 2){
...
/*                 if(T->tours[last][T->indice[last]] % 2 == T->tours[temp2][T->indice[temp2]] % 2){
            ...
            if(T->tours[temp2][T->indice[temp2]] < T->tours[last][T->indice[last]]){deplacer(T,temp2,last);}
            else {deplacer(T,temp2,temp1);last = temp1;}
        }
        else{
            if(T->tours[temp1][T->indice[temp1]] < T->tours[last][T->indice[last]]){deplacer(T,temp1,last);}
