...
function NewProds(){
  ...
  let newProducts = [{img:"https://contents.mediadecathlon.com/p2155572/k$82c53deb06b3aa4145acc69227e616c9/sq/8544265.jpg?format=auto&f=800x0",nom:"Nike Air Max 270",prix:100},
  {img:"https://assets.laboutiqueofficielle.com/w_210,q_auto,f_auto/media/products/2021/05/31/reebok_268771_FAB_GW8357_TPDT_20210615T073244_01.jpg",nom:"Nike Air Max 270",prix:100},
  {img:"https://contents.mediadecathlon.com/p2155572/k$82c53deb06b3aa4145acc69227e616c9/sq/8544265.jpg?format=auto&f=800x0",nom:"Nike Air Max 270",prix:100},
  {img:"https://contents.mediadecathlon.com/p2155572/k$82c53deb06b3aa4145acc69227e616c9/sq/8544265.jpg?format=auto&f=800x0",nom:"Nike Air Max 270",prix:100},
  {img:"https://contents.mediadecathlon.com/p2155572/k$82c53deb06b3aa4145acc69227e616c9/sq/8544265.jpg?format=auto&f=800x0",nom:"Nike Air Max 270",prix:100},
  ]
  return(
  ...
  <Slider {...settings}>
    {
      newProducts.map((prod)=>{
        return(
          <a href="" className="flex flex-col items-center justify-center h-64 w-24 text-white hover:bg-white hover:text-black transition rounded-xl">
